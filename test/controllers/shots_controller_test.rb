...
class ShotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shot" do
    assert_difference('Shot.count') do
      post shots_url, params: { shot: { description: @shot.description, title: @shot.title, url: @shot.url, user_id: @shot.user_id, user_shot: @shot.user_shot } }
    end
  ...
  test "should update shot" do
    patch shot_url(@shot), params: { shot: { description: @shot.description, title: @shot.title, url: @shot.url, user_id: @shot.user_id, user_shot: @shot.user_shot } }
